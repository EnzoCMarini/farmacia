...
router.post("/api/medicamento", MedicamentoController.novo);
router.get("/api/medicamento/:nome", MedicamentoController.medicamentoNome);
router.get("/api/medicamento/:princ_Ativo", MedicamentoController.medicamentoPrinc_Ativo)
